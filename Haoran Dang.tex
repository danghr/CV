...
\titlespacing{\subsection}{0pt}{0pt}{0pt} % Spacing around subsections
...
\subsection{TEACHING}
    ...
    \begin{itemize}
        \item \textbf{Operating System I} (TA) \hfill ShanghaiTech \quad Fall, AY 2021 \datetlide 2022
    \end{itemize}
\end{keepsection}
...
\section{SKILLS}
\begin{itemize}
    \item \textbf{Programming Languages}: C/C++, Python, Shell, Verilog
    \item \textbf{Tools \& Frameworks}: PyTorch, \LaTeX, Jekyll
...
\begin{itemize}
    \item \textbf{2022 SIST Outstanding Thesis} {\small (for final year project)} \hfill ShanghaiTech \quad 2022-06
...
\begin{itemize}
    \item \textbf{20th Public Science Day of ICT, CAS} \quad {\small Remote camera operator.} \hfill ICT, CAS \quad 2024-05
    \item \textbf{``Sunflower Activity'' - Haidian Hospital Volunteers} \quad {\small Assistant in Service Center} \hfill ICT, CAS \quad 2023-12
