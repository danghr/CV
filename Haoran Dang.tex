...
\begin{itemize}
    ...
    \begin{small}
        \begin{itemize}
            ...
            \item Conducted research to accelerate full-graph GNN accurate inference on multi-GPU platforms. Developed and implemented GDL-GNN, an optimized GPU data-loading method based on graph partitioning to minimize data accesses outside GPU memory, resulting in a 59.9\% performance improvement over the baseline. (cf. Publication \ref{GDL-GNN-Paper})
